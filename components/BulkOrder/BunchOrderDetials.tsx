              ...
              <tr key={index}>
                ...
                <td className="p-2">
                  <input
                    ...
                    className={`form-control ${styles.table_desc}`}
                    onChange={(e) => handleChangeArray(e, index, 'bunch_weight')}
                  />
                </td>
                ...
                <td className="p--2">
                  <input
                    ...
                    className={`form-control ${styles.table_desc}`}
                    onChange={(e) => handleChangeArray(e, index, 'weight_per_unit')}
                    disabled
                  />
                </td>
                <td className="p-2">
                  <input
                    ...
                    onChange={(e) => handleChangeArray(e, index, 'estimate_bunch_weight')}
                    disabled
                  />
                </td>
                <td className="text-end p-2">
                  <button className={styles.delete_btn} onClick={() => deleteBunchOrderRow(index)}>
                    Delete
                  </button>
                </td>
              </tr>
