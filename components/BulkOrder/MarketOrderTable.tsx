...
const MarketOrderTable = ({ formData, addMarketOrderRow, deleteMarketOrderRow, errorMsg, handleChangeArray, refCodesList }: any) => {
    ...
    <>
      <div className="row mt-4 mb-2">
        <div className="col-md-9">
          <p className="">
            <b>Market Order Details</b>
          </p>
        </div>
        <div className="col-md-3 d-flex justify-content-end">
          <button className={styles.add_more_btn} onClick={addMarketOrderRow}>
            Add More
          </button>
        </div>
      </div>
              ...
              formData?.marketOrderDetails?.map((row: any, index: any) => (
                <tr className="">
                  ...
                  <td className="p-1 text-end">
                    <button className={`${styles.delete_btn}`} onClick={() => deleteMarketOrderRow(index)}>
                      Delete
                    </button>
                  </td>
                </tr>
